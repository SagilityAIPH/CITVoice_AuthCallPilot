Public Module AuthenticationWorkflow
    Public Function CreateWorkflow() As ChecklistNode
        ...
        q1.Responses.Add(New WorkflowResponse("Yes", q2))
        q1.Responses.Add(New WorkflowResponse("No", endGhost))

        q2.Responses.Add(New WorkflowResponse("Yes", endRetro))
        q2.Responses.Add(New WorkflowResponse("No", q3))

        q3.Responses.Add(New WorkflowResponse("Yes", endAuth))
        q3.Responses.Add(New WorkflowResponse("No", endVerify))
